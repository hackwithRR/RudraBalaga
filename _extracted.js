            ...
            if (buses.length > 0) {
                ...
                buses.forEach(bus => {
                    ...
                    busDiv.innerHTML = `
                        ...
                        ${isSelected ? `
                            <!-- Bus Details: rename bus, add number & driver once finalized (a few days before the event) -->
                                            ...
                                            ` : `
                                                <li class="flex justify-between items-center gap-3 p-2 bg-surface-container-high rounded-lg">
                                                    ...
                                                    <div class="flex items-center gap-2 shrink-0">
                                                        <button type="button" class="edit-route-btn touch-active bg-secondary-container text-on-secondary-container px-3 py-1.5 rounded-lg font-bold text-sm" data-route-id="${route.id}" data-bus-id="${bus.id}" data-event-id="${eventId}">Edit</button>
        ...
        function showToast(message, icon = 'check_circle') {
            ...
            toastHideTimer = setTimeout(() => {
                ...
                toastTransitionTimer = setTimeout(() => toast.classList.add('hidden'), 320);
            }, 3000);
        }
